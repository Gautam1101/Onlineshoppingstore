...
<!======================================BANNER==============================>
<div class="slideshow-container" style="box-shadow: 2px 2px 8px white; height: 600px; width: 600px;">
      <div class="mySlides fade">
           <div class="text">1/3</div>
        <img src="img/products/j1-2.jpg" style="width:100%;">
          </div>
      <div class="mySlides fade">
     <div class="text">2/3</div>
        <img src="img/products/j1-3.jpg" style="width:100%;">
      </div>
      <div class="mySlides fade">
         <div class="text">3/3</div>
        <img src="img/products/j1-1.jpg" style="width:100%;">
      </div>
...
<form method="post" action="mycart.php?action=add&id=<?php echo $row["id"];?>">
       <div style="text-align: center;">
<h1 style="color: powderblue;">Men's Navy Blue Denim.</h1></br>
         <h2>100% Cotton.</h2></br>
         <h2>Slim Fit Medium(30).</h2>
</div>
