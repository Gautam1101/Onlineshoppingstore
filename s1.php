...
<div class="slideshow-container" style="box-shadow: 2px 2px 8px white; height: 600px; width: 600px;">
      <div class="mySlides fade">
        ...
        <img src="img/products/s1-3.jpg" style="width:100%;">
          </div>
      <div class="mySlides fade">
     <div class="text">2/3</div>
        <img src="img/products/s1-2.jpg" style="width:100%;">
      </div>
      <div class="mySlides fade">
...
<?php 
$query = "SELECT *FROM cart1 where id=1";
...
<form method="post" action="mycart.php?action=add&id=<?php echo $row["id"];?>">
       <div style="text-align: center;">
<h1 style="color: powderblue;">Men's Checked shirt.</h1></br>
         <h2>100% Cotton.</h2></br>
         <h2>Slim Fit Medium(38).</h2>
</div>
